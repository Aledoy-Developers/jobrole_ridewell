...
<html lang="en">
  <head>
    ...
    <title>Ride Well |  Executive / VIP Drivers</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 d-flex justify-content-center align-items-center">
            <img src="images/Executive-driver1.jpg" class="img-fluid" />
          </div>
          <div class="col-md-7">
            <div class="container hi">
              <div class="card shadow-sm border-0 rounded-4 p-md-5 bg-white">
                <h6 class="text-uppercase mb-2">
                  Executive /VIP Drivers <span><i class="bi bi-car-front-fill"></i></span>
                </h6>
                <h2 class=" mb-4">
                    Dedicated Chauffeur Services for Executive  Comfort and Local Expertise.
                </h2>

                <p class="text-muted mb-5">
                 Designed for business leaders, top professionals, and high-profile clients who value confidentiality, safety, and luxury. Our Executive/VIP drivers are highly trained, well-groomed, and skilled at managing premium vehicles to deliver a first-class chauffeur experience.
                </p>
                    ...
                    <div class="d-flex">
                      ...
                      <div>
                        ...
                        <p class="text-muted mb-0">
                            We adapt to your lifestyle  from corporate travel to family errands.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="d-flex">
                      ...
                      <div>
                        ...
                        <p class="text-muted mb-0">
                          All drivers are vetted, licensed, and trained to meet international standards.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="d-flex">
                      ...
                      <div>
                        ...
                        <p class="text-muted mb-0">
                          Our admin team monitors each ride and provides quick support when needed.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="d-flex">
                      ...
                      <div>
                        ...
                        <p class="text-muted mb-0">
                          Your privacy is respected, and our drivers maintain a professional demeanor at all times.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="mt-5 button">
                  <a href="book-a-driver?type=Executive Driver">
                    <button>Book executive chaffeurs now</button>
                  </a>
                </div>
              </div>
            </div>
    ...
    <!-- <section class="pt-5 mt-5">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="hi mb-3">
                        <h3>WHAT TO EXCEPT <span><i class="bi bi-car-front-fill"></i></span></h3>
                        <h2>When You Choose Executive/VIP Drivers.</h2>   
                    </div>
                    <div class="level">
                        <div class="why_choose_left-progress">
                        <div class="why_choose_left-progress-details">
                            <div class="why_choose_left-progress-detailsss">Professional Service</div>
                            <div class="why_choose_left-progress-detailsss">95%</div>
                        </div>
                        <div class="why_choose_left-progress-file">
                            <div class="progress">
                                <div class="progress-bar" role="progressbar" aria-valuenow="30" aria-valuemin="0" aria-valuemax="100" style="width:78%">
                                </div>
                            </div>
                        </div>                        
                    </div>
                    ...
                    <div class="why_choose_left-progress">
                        <div class="why_choose_left-progress-details">
                            <div class="why_choose_left-progress-detailsss">Comfort & Safety</div>
                            <div class="why_choose_left-progress-detailsss">98%</div>
                        </div>
                        <div class="why_choose_left-progress-file">
                            <div class="progress">
                    ...
                    <div class="why_choose_left-progress">
                        <div class="why_choose_left-progress-details">
                            <div class="why_choose_left-progress-detailsss">Route Efficiency</div>
                            <div class="why_choose_left-progress-detailsss">95%</div>
                        </div>
                        <div class="why_choose_left-progress-file">
                            <div class="progress">
                ...
                <div class="col-md-6">
                    <img src="images/Executive-driver2-1.jpg" class="img-fluid">
                </div>
            </div>
        </div>
    </section> -->
        ...
        <div class="col-12 col-lg-6 d-flex">
          <div class="p-5 text-white rounded-3 w-100" style="background-color: #003a8d; height: ;">
            <h2 class="display-5 fw-bold mb-4">
              Book Your Executive / VIP Drivers Today
            </h2>
