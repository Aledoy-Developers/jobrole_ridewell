...
<html lang="en">
  <head>
    ...
    <title>Ride Well | Corporate Drivers</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-5 d-flex justify-content-center align-items-center">
            <img src="images/Coperate-drver1.jpg" class="img-fluid" />
          </div>
          <div class="col-md-7">
            <div class="container hi">
              <div class="card shadow-sm border-0 rounded-4 p-md-5 bg-white">
                <h3 class="text-uppercase mb-2">
                  CORPORATE CHAUFFEURS <span><i class="bi bi-car-front-fill"></i></span>
                </h3>
                <h2 class=" mb-4">
                    Seamless, professional rides designed 
                    for busy corporate schedules.
                </h2>

                <p class="text-muted mb-5">
                 Tailored for organizations that need dependable drivers for staff mobility, official assignments, or logistics. Ridewell corporate drivers are trained in professionalism, time management, and efficiency, making them the perfect fit for business environments.
                </p>
                ...
                <div class="row gy-4">
                    ...
                    <div class="d-flex">
                      ...
                      <div>
                        ...
                        <p class="text-muted mb-0">
                          All chauffeurs are background checked, experienced, and well-trained for corporate etiquette.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="d-flex">
                      ...
                      <div>
                        ...
                        <p class="text-muted mb-0">
                          We prioritize timeliness to keep your schedule running smoothly.
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-6">
                    <div class="d-flex">
                      ...
                      <div>
                        <h5 class="fw-semibold mb-1">Comfort & Discretion</h5>
                        <p class="text-muted mb-0">
                          Travel in a calm, private environment with professional conduct guaranteed.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div class="mt-5 button">
                  <a href="book-a-driver">
                    <button>Book corporate chaffeurs now</button>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="hi mb-3">
                        ...
                        <h2>When You Choose Corporate Chauffeurs</h2>   
                    </div>
                    <div class="level">
                ...
                <div class="col-md-6">
                    <img src="images/Coperate-driver2.jpg" class="img-fluid">
                </div>
            </div>
        </div>
    </section> -->
        ...
        <div class="col-12 col-lg-6 d-flex">
          <div class="p-5 text-white rounded-3 w-100" style="background-color: #003a8d; height: ;">
            <h2 class="display-5 fw-bold mb-4">
              Book Your Corporate Chauffeur Today
            </h2>
