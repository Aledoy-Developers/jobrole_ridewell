...
<body>
    ...
    <form action="proc_vacancy" method="post" enctype="multipart/form-data" class="container">
        <div class="row">
            <label class="mb-4">Enter your information to get started with us</label>
            ...
            <div class="col-md-6 d-flex flex-column my-2">
                ...
                <input type="text" name="firstname" class="form5 mt-2" placeholder="Enter firstname"
            ...
            <div class="col-md-6 d-flex flex-column my-2">
                ...
                <input type="text" name="lastname" class="form5 mt-2" placeholder="Enter lastname"
            ...
            <div class="col-md-6 d-flex flex-column my-2">
                <label>Email</label>
                <input type="text" name="email" class="form5 mt-2" placeholder="Enter email"
            ...
            <div class="col-md-6 d-flex flex-column my-2">
                <label>Phone</label>
                <input type="text" name="phone" class="form5 mt-2" placeholder="Enter phone"
            ...
            <div class="col-md-6 d-flex flex-column my-2">
                ...
                <input type="text" name="address_1" class="form5 mt-2" placeholder="Enter Address 1"
                    value="<?= htmlspecialchars($address_1 ?? '') ?>">
            </div>

            <!-- Address 2 -->
            <div class="col-md-6 d-flex flex-column my-2">
                <label>Address 2</label>
                <input type="text" name="address_2" class="form5 mt-2" placeholder="Enter Address 2"
                    value="<?= htmlspecialchars($address_2 ?? '') ?>">
            </div>
            ...
            <div class="col-md-6 d-flex flex-column my-2">
                ...
                <input type="text" name="local_gov" class="form5 mt-2" placeholder="Enter local government area"
                    value="<?= htmlspecialchars($local_gov ?? '') ?>">
            </div>
            ...
            <div class="col-md-6 d-flex flex-column my-2">
                ...
                <textarea name="additional_info"
                    class="form5"><?= htmlspecialchars($additional_info ?? '') ?></textarea>
            </div>

            <!-- License number -->
            <div class="col-md-6 d-flex flex-column my-2">
                <label>License number</label>
                <input type="text" name="license_no" class="form5 mt-2" placeholder="Enter license"
                    value="<?= htmlspecialchars($license_no ?? '') ?>">
            </div>
            ...
            <div class="col-md-6 d-flex flex-column my-2">
                ...
                <input type="date" name="dob" class="form5 mt-2" value="<?= htmlspecialchars($dob ?? '') ?>">
            </div>
            ...
            <div class="col-md-6 d-flex flex-column mt-1">
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="agree">
                        ...
                        <strong><a href="terms_driver.php" target="blank_" class="text-decoration-none text-dark">Terms
