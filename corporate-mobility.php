...
<head>
    ...
    <title>Ride Well | Corporate Mobility</title>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="container hi">
                        <div class="card shadow-sm border-0 rounded-4 p-md-5 bg-white">
                            <h6 class="text-uppercase mb-2">
                                CORPORATE MOBILITY SOLUTION <span><i class="bi bi-car-front-fill"></i></span>
                            </h6>
                            <h2 class=" mb-4">
                                Your trusted partner for dependable and scalable corporate mobility.
                            </h2>

                            <p class="text-muted mb-5">
                                We support businesses with tailored mobility services to keep their staff and executives
                                moving smoothly.
                            </p>
                            ...
                            <div class="row gy-4">
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-1">
                                                Daily staff shuttle and shift drivers.
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-1">
                                                Executive transportation for management and board members.
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-1">
                                                Driver outsourcing for company fleets.
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-1">
                                                Standby driver pools for emergency needs.
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            <h5 class="fw-semibold mb-1">
                                                Mobility support for corporate events and conferences.
                                            </h5>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mt-5 button">
                                <a href="book-a-driver">
                                    <button>Book corporate mobility now</button>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-5 d-flex justify-content-center align-items-center">
                    <img src="images/Rectanglee62.jpg" class="img-fluid" />
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container-fluid p-0">
            <div class="row g-0">
                ...
                <div class="col-12 col-lg-6">
                    <img src="images/man_phone.jpg" class="img-fluid h-100 object-fit-cover"
                        alt="Business man checking phone near a white luxury car">
                </div>
                ...
                <div class="col-12 col-lg-6 p-5 p-md-5" style="background-color: #003a8d; color: white;">
                    ...
                    <h2 class="display-6 fw-bold mb-5">
                        When You Choose Corporate Mobility Solutions.
                    </h2>
                    ...
                    <div class="col-12 col-lg-6 d-flex">
                        <div class="p-5 text-white rounded-3 w-100" style="background-color: #003a8d; height: ;">
                            <h2 class="display-5 fw-bold mb-4">
                                Book Our Corporate Mobility Today.
                            </h2>
