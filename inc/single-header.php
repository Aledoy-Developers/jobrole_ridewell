<section>
    ...
    <div class="navbar-bg1"
        style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.5)), url('images/<?php echo $banner_bg; ?>') no-repeat center; background-size: cover;">
        <div class="container">
        ...
        <div class="container">
            <div class="banner-text1 text-white">
                <h2>
                    <?php echo $banner_title; ?> <i class="bi bi-car-front-fill"></i>
                </h2>
