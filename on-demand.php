...
<head>
    ...
    <title>Ride Well | On Demand Drivers</title>
                    ...
                    <div class="container hi">
                        <div class="card shadow-sm border-0 rounded-4 p-md-5 bg-white">
                            <h6 class="text-uppercase mb-2">
                                ON-DEMAND DRIVERS <span><i class="bi bi-car-front-fill"></i></span>
                            </h6>
                            <h2 class=" mb-4">
                                Reliable drivers at your service, anytime you need them.
                            </h2>

                            <p class="text-muted mb-5">
                                Need a driver at short notice? Ridewell offers flexible, on-demand driver deployment for
                                individuals, families, and organizations. Whether for a few hours, a day, or a longer
                                period, our drivers are available whenever you need them..
                            </p>
                            ...
                            <div class="mt-5 button">
                                <a href="book-a-driver">
                                    <button>Book on-demand driver now</button>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="hi mb-3">
                        ...
                        <h2>When You Choose On-Demand Drivers</h2>
                    </div>
                    <div class="level">
                ...
                <div class="col-md-6">
                    <img src="images/Rectanglep40.jpg" class="img-fluid">
                </div>
            </div>
        </div>
    </section> -->
